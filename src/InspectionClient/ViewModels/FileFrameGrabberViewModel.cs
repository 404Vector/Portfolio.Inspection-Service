...
public partial class FileFrameGrabberViewModel : FrameGrabberViewModelBase
{
  ...
  [
    ...
    new() { Key = "source_mode",      DisplayName = "Source Mode",      ValueType = ParameterValueType.String, MinValue = null, MaxValue = null,   CurrentValue = "gradient",   OriginalValue = "gradient",   AllowedValues = ["gradient", "file"]               },
