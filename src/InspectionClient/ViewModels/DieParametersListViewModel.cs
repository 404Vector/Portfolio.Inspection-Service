...
/// <summary>
/// Die 파라미터 목록의 읽기 전용 뷰 — DbTableControl의 Load/Refresh 전용.
/// WaferSetupWorkflow에서 DieSize 가져오기에 사용된다.
/// DbTableControl이 LoadedItem 상태를 자체 관리하므로 IsItemLoaded 불필요.
/// </summary>
public sealed partial class DieParametersListViewModel : ViewModelBase
{
  ...
  public DieParametersListViewModel(
