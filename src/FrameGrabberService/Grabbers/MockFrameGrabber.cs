...
public sealed class MockFrameGrabber : IFrameGrabber
{
    ...
    public ParameterValue GetParameter(string key) => key switch
    {
        "frame_rate_hz" => new ParameterValue.DoubleValue(_config.FrameRateHz),
        "width"         => new ParameterValue.Int64Value(_config.Width),
        "height"        => new ParameterValue.Int64Value(_config.Height),
        "pixel_format"  => new ParameterValue.StringValue(_config.PixelFormat.ToString()),
